...
const Sidebar = ({
  ...
  setSidebarOpen: setParentSidebarOpen,
}) => {
  ...
  const menuItems = [
    ...
    // },
    {
      ...
      icon: Users,
      path: "dashboardlayout/ordermanagement",
    },
    {
      id: "customers",
      label: "Export Orders",
    ...
    },
    {
      ...
      label: "Notifications",
      icon: MessageSquare,
      path: "dashboardlayout/notification",
  ...
  return (
    <>
      ...
      <div
        className={`sidebar-container border-end ${
          isMobile ? (parentSidebarOpen ? "d-block" : "d-none") : "d-block"
      ...
      >
        ...
        <nav className="sidebar-nav">
          {menuItems.map(
            ({ id, label, icon: Icon, path, children, notificationCount }) => (
              <React.Fragment key={id}>
                <div
                  className={`nav-item d-flex align-items-center px-3 py-3 gap-2 mt-3 ${
                  ...
                  >
                    {children.map(
                      ({
                        ...
                        <div
                          key={childId}
                          className={`submenu-item align-items-center ${
                            activeSection === childId ? "active" : ""
                          }`}
                          style={{
                            marginTop: "10px",
                            cursor: "pointer",
        ...
        <div className="logout-section mt-auto p-3 d-flex align-items-center">
          ...
          {!isCollapsed && (
            <button
              className="logout-button btn btn-link ms-auto"
