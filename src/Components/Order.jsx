            ...
            {step === 1 && (
              <div id="orderDetailsTabUnique">
                <div className="mb-4">
                  ...
                  <div className="row g-3">
                    <div className="col-md-6">
                      <label htmlFor="fullNameUnique" className="form-label">
                        Full Name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="col-md-6">
                      <label htmlFor="emailUnique" className="form-label">
                        Email Address *
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="col-md-6">
                      <label htmlFor="mobileUnique" className="form-label">
                        Mobile Number *
                      </label>
                      <input
                        type="tel"
                ...
                <div className="mb-4">
                  ...
                  <label htmlFor="requirementsUnique" className="form-label">
                ...
                <div className="mb-4">
                  <h5>File Upload</h5>
                  <label
                    className="order-file-upload-unique d-block"
              ...
              <div id="paymentTabUnique">
                ...
                <div className="d-flex justify-content-between mt-4">
                  ...
                  <button
                    ...
                    onClick={() => setStep(3)}
                  >
                    Complete Payment <span className="ms-1">→</span>
                  </button>
                </div>
              </div>
            )}
